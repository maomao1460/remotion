...
其中，内容检查会确认：4 条热点齐全、每个核心数字至少有两条来源、来源链接可访问、采用值与差异处理已写明；每张“偏积极／偏谨慎／中性观察”卡片必须注明独立的媒体评论、机构观点或政策方观点来源。政策方观点会在画面和审核表中单独标注，不能当作独立第三方评论。字幕按旁白逐句拆分，程序会检查字幕拼接后与旁白稿完全一致。正式出片还会检查旁白时长、1920×1080 / 30 帧 / 60 秒、音轨和关键画面。旁白、背景音乐、成片与临时检查图都留在本机，不会上传 Git；内容包、源码和审核记录会随 Git 保存，方便换电脑后复用。
